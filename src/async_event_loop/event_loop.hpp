 ...
 *
 * Defaults can be overridden before including async_event_loop.hpp:
 *
 *   #define ASYNC_EVENT_LOOP_DEFAULT_MAX_CALLBACKS 16
 *   #define ASYNC_EVENT_LOOP_DEFAULT_CALLBACK_STORAGE_SIZE 48
